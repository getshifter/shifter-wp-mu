...
function activate_shifter() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-shifter-activator.php';
...
function deactivate_shifter() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-shifter-deactivator.php';
